 ...
 */
public class AdapterJugadorCategoria extends RecyclerView.Adapter<AdapterJugadorCategoria.ViewHolder>{
    public Context context;
    private List<Persona> my_Data;
    private RecyclerViewOnItemClickListener recyclerViewOnItemClickListener;

    public AdapterJugadorCategoria(Context context, List<Persona> my_Data, RecyclerViewOnItemClickListener
    ...
    private void Eliminar_Jugador(int id,final Context context) {
        String id_evento=String.valueOf(Recursos_Mantenimientos.TEMP.getCategoria_temporal().getId());
        ...
        EliminarJugadorCategoria validarSesion = new EliminarJugadorCategoria(id_evento,id_persona, responseListener);
