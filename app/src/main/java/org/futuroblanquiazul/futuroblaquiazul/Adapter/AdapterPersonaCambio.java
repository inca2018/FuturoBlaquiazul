 ...
 */
public class AdapterPersonaCambio extends RecyclerView.Adapter<AdapterPersonaCambio.ViewHolder>{
    public Context context;
    private List<PersonaEstadistico> my_Data;
    private RecyclerViewOnItemClickListener recyclerViewOnItemClickListener;
    AlertDialog da;

    public AdapterPersonaCambio(Context context, List<PersonaEstadistico> my_Data, RecyclerViewOnItemClickListener
