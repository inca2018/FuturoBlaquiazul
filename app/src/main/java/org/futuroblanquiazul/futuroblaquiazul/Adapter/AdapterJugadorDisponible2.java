 ...
 */
public class AdapterJugadorDisponible2 extends RecyclerView.Adapter<AdapterJugadorDisponible2.ViewHolder>{
    public Context context;
    private List<Persona> my_Data;
    private RecyclerViewOnItemClickListener recyclerViewOnItemClickListener;

    public AdapterJugadorDisponible2(Context context, List<Persona> my_Data, RecyclerViewOnItemClickListener
    ...
    private void Agregar_Persona_a_Evento(int id,final Context context) {
        String id_plantel=String.valueOf(Recursos_Mantenimientos.TEMP.getCategoria_temporal().getId());
        ...
        Response.Listener<String> responseListener = new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    if (success) {
                        CategoriasJugadoresActivity.GESTOR.Actualizar_Listas(context);
                    }else {
        ...
        AgregarJugadorCategoria validarSesion = new AgregarJugadorCategoria(id_plantel,id_persona,estado, responseListener);
