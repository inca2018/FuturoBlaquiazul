...
import org.futuroblanquiazul.futuroblaquiazul.Peticiones.AgregarJugadorCategoria;
import org.futuroblanquiazul.futuroblaquiazul.Peticiones.AgregarJugadorEquipo;
 ...
 */
public class AdapterJugadorDisponible3 extends RecyclerView.Adapter<AdapterJugadorDisponible3.ViewHolder>{
    public Context context;
    private List<Persona> my_Data;
    private RecyclerViewOnItemClickListener recyclerViewOnItemClickListener;

    public AdapterJugadorDisponible3(Context context, List<Persona> my_Data, RecyclerViewOnItemClickListener
    ...
    public  class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener  {
         ...
         ImageView accion;
         ImageView foto;
         TextView nombre_persona,categoria;
        public ViewHolder(View itemView) {
            ...
            categoria=itemView.findViewById(R.id.card_disponible_categoria);
        }
        @Override
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView= LayoutInflater.from(parent.getContext()).inflate(R.layout.card_jugador_disponible2,parent,false);
    ...
    private void Agregar_Persona_a_Evento(int id,final Context context) {
        String id_plantel=String.valueOf(Recursos_Mantenimientos.TEMP.getEquipo_temporal().getId());
        ...
        AgregarJugadorEquipo validarSesion = new AgregarJugadorEquipo(id_plantel,id_persona,estado, responseListener);
