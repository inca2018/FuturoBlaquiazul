...
public class ActualizarUsuario extends StringRequest {
    ...
    public ActualizarUsuario(String usuario, String pass, String nom, String ape, String dni, String area, String cargo, String correo, String tipo, String estado, String foto,String id_user,String ruta,String foto_nom,String foto_nom_antigua,String dni_antiguo,  Response.Listener<String> listener) {
