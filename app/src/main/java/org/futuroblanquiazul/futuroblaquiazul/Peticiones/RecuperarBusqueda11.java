...
public class RecuperarBusqueda11 extends StringRequest {

    private static final String LOGIN_REQUEST_URL = Conexion.RUTA_SERVICIO_INFORMACION;
    private Map<String, String> params;

    public RecuperarBusqueda11(String inicio, String fin, String departamento , Response.Listener<String> listener) {
        super(Method.POST, LOGIN_REQUEST_URL,listener, null);
        params = new HashMap<>();
        params.put("operacion","recuperar_busqueda11");
